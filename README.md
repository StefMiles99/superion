...
"Super-" viene del latín: encima de, por sobre, más allá de. Es la raíz de superior, supremo, supervisar. Tu cerebro registra "algo que está por encima" antes de pensar.
"-ion" es la terminación que en español y en inglés usan tanto las entidades técnicas (ion, protón, fusión) como los nombres de titanes y colosos de la ficción. Le da cuerpo de ente, no de producto.
Y el eco más importante: Hiperión (Hyperion), el titán griego de la luz celeste, padre del sol. Su nombre significa literalmente "el que camina en las alturas". SUPERION suena a primo latino de Hiperión — y esa resonancia mitológica es lo que le da el peso de "respeto" que pedías, sin que nadie tenga que saber griego para sentirlo.
